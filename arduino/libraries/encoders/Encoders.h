...
//   {
     ...
     // {
      ...
      public:
        ...
        //! @brief Compute the left motor shaft rotations
        //!
        //! @param[in] Return the number of rotations
        //!
        float leftCounts();

        //! @brief Compute the right motor shaft rotations
        //!
        //! @param[in] Return the nummber of rotations
        //!
        float rightCounts();
